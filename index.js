...
app.get("/posts/:id",function(req,res){
  ...
  if(!foundPost) res.sendStatus(404).send({error:"Post not found"});
  res.json(foundPost);
});
...
app.patch('/posts/:id', function (req,res) {
  ...
  const newIndex=posts.findIndex((post)=>post.id===id);
  posts[newIndex]=newPost;
